...
# CONVERT ALL EXCEL BOOKS IN INPUT FOLDER TO DATAFRAMES ---------------------
...
#Run this cell to convert all Excel books in the input folder into tuple key-value pairs that can be indexed
clean_book_tuple_list  = [convert_excel_to_dataframe(book) for book in list_of_raw_books]
...
for i in range(len(clean_book_tuple_list)):
    ...
    current_df = clean_book_tuple_list[0][1]
    current_df_title = clean_book_tuple_list[0][0]
