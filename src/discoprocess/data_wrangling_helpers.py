...
def wrangle_batch(b, name_sheets, replicate_index):
    ...
    for i in range(len(name_sheets)):
        ...
        for coords in sheet_coords_list:
            ...
            # Hard coding concentration - 20uM is the default 
            # TO DO: search polymer name string for the concentration if not 20, and update from there
...
def get_dofs(peak_indices_array, df):
